...
// call: node createIndex.js --indexFile=./index.json --serviceName=ghostblog --indexName=posts --adminKey=ABC
...
if (hasError) {
    ...
    console.log('node createIndex.js --indexFile=./index.json --serviceName=ghostblog --indexName=posts --adminKey=ABC');
    process.exit();
}
